...
async function startWS() {
  ws = new WebSocket(`${wsURL}/chap9/ws?room=${room.id}`)
...
async function handleICECandidate(payload) {
  ...
  try {
    ...
    console.log("Error adding ICE candidate ", payload);
    return
  }
}
...
async function joinCall(e) {
  ...
  console.log("Join message sent. ", user);
}
...
async function start() {   
  ...
  console.log("Connection message sent. ", user);
